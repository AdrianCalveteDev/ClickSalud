<fieldset>
    ...
    <input name="nombre" type="text" placeholder="Nombre del servicio" value="<?php echo s($servicio->nombre); ?>">

    <label for="descripcion">Descripción:</label>
    <textarea name="descripcion" id="descripcion" placeholder="Descripción del servicio"><?php echo s($servicio->descripcion);?></textarea>

    <label for="imagen">Imágen</label>
    <input name="imagen" type="file" id="imagen" accept="image/png, image/jpeg">

    <label for="precio">Precio:</label>
    <input name="precio" type="number" id="precio" placeholder="Precio del servicio" value="<?php echo s($servicio->precio);?>">

    <label for="duracion">Duración (min):</label>
    <input name="duracion_min" type="number" id="duracion" placeholder="Duración en minutos" min="30" max="120" value="<?php echo s($servicio->duracion_min);?>">
